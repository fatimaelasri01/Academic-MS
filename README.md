...
<div style="display: flex; justify-content: center; align-items: center; border: 1px solid #ddd; border-radius: 10px; background-color: #f5f5f5; padding: 20px;">
  ...
  <div style="flex: 1; text-align: center; padding: 20px;">
    ...
    <img src="https://cdn.intra.42.fr/users/1773980665edff85923669726051d06a/small_fel-asri.jpg" alt="Fatima El Asri" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;">
    <p><strong>Role:</strong> Backend Developer</p>
    <p><strong>Expertise:</strong> Java Spring Boot, MySQL, API Design</p>
  </div>
</div>

## Features of Academic-MS

The **Academic-MS** microservice is responsible for managing all academic-related data and activities within the **Private School Management System**. This service ensures seamless organization of student and class assignments, academic schedules, and results management.  

### Core Responsibilities:
- **Student and Class Management:**  
  - Manage student profiles, class assignments, and grouping.  
  - Organize classes and their associated schedules.  

- **Subjects and Lessons:**  
  - Define and manage subjects and associated lessons.  
  - Link subjects to academic schedules.  

- **Evaluations and Grading:**  
  - Conduct student evaluations and grade assignments.  
  - Generate academic progress reports and results.  

- **Timetable and Scheduling Integration:**  
