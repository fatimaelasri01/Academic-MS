...
public interface TeacherScheduleService {
    TeacherScheduleDto createTeacherSchedule(TeacherScheduleDto teacherScheduleDto, MultipartFile file, String token);
    ...
    TeacherScheduleDto getTeacherScheduleByTeacher(String token);
}
